...
#my_model.summary()
mycallback=[]
tbCallback = TensorBoard(log_dir='/home/lfan/Dropbox/runCoAtt/vgg16/regress/graph/',
...
model_checkpoint = ModelCheckpoint('/home/lfan/Dropbox/runCoAtt/vgg16/regress/model/gazefollow_regress.weights.{epoch:02d}-{val_loss:.2f}.hdf5',
...
my_model.load_weights('/home/lfan/Dropbox/runCoAtt/vgg16/regress/model/gazefollow_regress_finalweights.h5')


def compute_score(testid):
    datapath = '/home/lfan/Dropbox/runCoAtt/vgg16/mydata/test/'+str(testid)+'/'
